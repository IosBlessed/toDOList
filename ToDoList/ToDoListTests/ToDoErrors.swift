...
enum ToDoErrors: String, Error {
    ...
    case unabelToAddTaskToStorageTaskExists
    case unableToDeleteTaskInteractionError
    case unableToProcessTextFieldIncorrectInput
    case unableToCheckTaskStatus
    case unableToReassigneDateToTask
    case unableToProcessSectionsForTasks
}
